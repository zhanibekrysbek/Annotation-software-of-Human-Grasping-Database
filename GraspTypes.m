...
%      GRASPTYPES, by itself, creates a new GRASPTYPES or raises the existing
%      singleton*.
%
%      H = GRASPTYPES returns the handle to a new GRASPTYPES or the handle to
%      the existing singleton*.
%
%      GRASPTYPES('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GRASPTYPES.M with the given input arguments.
%
%      GRASPTYPES('Property','Value',...) creates a new GRASPTYPES or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before GraspTypes_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to GraspTypes_OpeningFcn via varargin.
%
